    ...
    const updateUser = async () => {
      try {
        ...
        let response = await axios.put(
          `https://jdrichardstech-test-dave.herokuapp.com/users/update`,
          this.state.user,
          axiosConfig
        );
      ...
      <div className='ui' style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ marginTop: '50px' }}>
          ...
          >
            <h2>
              Name:{' '}
              {this.props.user.name ? this.props.user.name : 'PlaceHolder'}
            </h2>
            ...
            >
              ...
              <div className='field'>
                ...
                <div className='ui fluid input'>
                  <input
                    type='password'
                    name='retypeNPassword'
                    value={retypeNPassword}
                    onChange={this.handleChange}
                  />
                </div>
              </div>
